    ...
    <>
        <footer className="border-t border-white/10 bg-black px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="text-center sm:text-left">
                <p className="text-sm text-white/60">© 2025 Ar-photo. Tous droits réservés.</p>
            </div>
            <div className="flex gap-6">
                ...
                >
                <Instagram className="h-6 w-5 text-white/60" />
                ...
                <a href="https://x.com/AndryRobson" className="text-white/60 hover:text-white">
